...
export const getAllExternalCompanies = catchAsync(
  async (req: Request, res: Response) => {
    const companies = await externalCompanyService.getAllCompanies();
    res
      .status(200)
      .json({ success: true, results: companies.length, data: companies });
  }
);

export const getExternalCompanyById = catchAsync(
  async (req: Request, res: Response) => {
...
export const getExternalCompaniesByCategory = catchAsync(
  async (req: Request, res: Response) => {
    ...
    const companies = await externalCompanyService.getCompaniesByCategory(
      categoryId
    );
    res
      .status(200)
