...
export default function CitizenProfilePage() {
	...
	return (
		<div className="flex flex-col rounded-xl shadow-xl border border-gray-600 p-8 gap-3 h-full">
			<SubTitle fontSize="text-[1.9rem]">{user.username}</SubTitle>
			<Form height="h-full" gap="gap-4" onSubmit={handleSubmit}>
				<div className="flex flex-col h-full justify-between">
					...
					<div className="flex flex-row gap-7 mt-auto">
						<DangerButton
							pending={isPending}
